...
class ReflexAgent(Agent):
    ...
    def getAction(self, gameState):
        ...
        """
        # Collect legal moves & successor states
        legalMoves = gameState.getLegalActions()

        # Choose 1 of best actions
        ...
        def evaluationFunction(self, currentGameState, action):
            ...
            # Stop action would reduce score because of pacman's timer constraint
            if action == 'Stop':
                score -= 50
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def max_value(self, gameState, index, depth):
        ...
        for action in legalMoves:
            ...
            # Update successor agent's index & depth if it's pacman
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def min_value(self, game_state, index, depth, alpha, beta):
        ...
        for action in legalMoves:
            ...
            # Update min_value & min_action for minimizer agent
            if current_value < min_value:
                min_value = current_value
                min_action = action
